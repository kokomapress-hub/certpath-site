...
<head>
  ...
  <link rel="stylesheet" href="/css/premium.css?v=9">
...
{FOOTER}
  ...
  <script src="/js/premium.js?v=9" defer></script>
  <script src="/js/app.js?v=20260918f" defer></script>
  <script src="/js/book.js?v=2" defer></script>
</body>
</html>
'''
